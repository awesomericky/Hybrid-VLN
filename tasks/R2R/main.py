...
parser.add_argument('--arch', default='hybrid', type=str,
                    help='options: hybrid')
parser.add_argument('--max_navigable', default=36, type=int,
...
parser.add_argument('--img_fc_use_angle', default=0, type=int,
...
def main(opts):
    ...
    tok = Tokenizer(opts.remove_punctuation == 1, opts.reversed, vocab=vocab, encoding_length=opts.max_cap_length)
